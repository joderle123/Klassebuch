...
| `screening.js`, `screening-bogen.js`, `screening.css` | Screening im Dossier (Beobachtungsbogen, keine Diagnose) und Übersicht aller Schüler; übernimmt auch frühere Screenings aus dem alten Klassenbuch. Der angefangene Bogen liegt bis zum Speichern im Sitzungsspeicher des Tabs – mit der Konto-ID, fremde Entwürfe werden verworfen. Ist der DS ausgefüllt, sind gleichbedeutende Aussagen im neuen Bogen schon beantwortet (Zuordnung `ausDs` im Bogen, markiert „DS“) |
